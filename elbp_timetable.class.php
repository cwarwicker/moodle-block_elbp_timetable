...
/**
 * Timetable plugin class for the ELBP.
 *
...
class elbp_timetable extends Plugin {
    ...
    private function setupMisRequirements() {
        ...
        if (!$this->mis_settings['dateformat']) {
            $this->mis_settings['dateformat'] = 'd-m-Y';
        }
        $this->mis_settings['mis_username_or_idnumber'] = $this->getSetting('mis_username_or_idnumber');
        if (!$this->mis_settings['mis_username_or_idnumber']) {
            $this->mis_settings['mis_username_or_idnumber'] = 'username';
        }
...
CSS;
        ...
        foreach ($classes as $class) {
            ...
            while ($startHour <= $endHour) {
                ...
                while ($startMin <= $lastMinutes) {
                    ...
                    if ($startMin < 10 && strlen($startMin) == 1) {
                        $startMin = "0".$startMin;
                    }
    ...
    private function buildMultiDimensionalArray() {
        ...
        if (!$endHour) {
            $endHour = $this->getDefaultEndHour();
        }
    ...
    public function getTextTimetable($day, $extraInfo = false) {
        ...
        if ($classes) {
            foreach ($classes as $class) {
                ...
                if ($class->getCourseID()) {
                    $output .= "<a href='{$this->CFG->wwwroot}/course/view.php?id={$class->getCourseID()}' target='_blank'>";
                }
                ...
                if ($class->getRoom()) {
                    $output .= " (".get_string('room', 'block_elbp_timetable')." {$class->getRoom()}) ";
                }
                if ($extraInfo && $class->getStaff()) {
                    $output .= " - " . $class->getStaff();
                }
                $output .= "</span><br>";
            }
        } else {
    ...
    public function ajax($action, $params, $ELBP) {
        ...
        switch ($action) {
            ...
            case 'save_colours_form':
                ...
                if (strlen($params['MON']) == 4) {
                    $params['MON'] = $params['MON'][0].$params['MON'][1].$params['MON'][1].$params['MON'][2].$params['MON'][2].$params['MON'][3].$params['MON'][3];
                }
                if (strlen($params['TUE']) == 4) {
                    $params['TUE'] = $params['TUE'][0].$params['TUE'][1].$params['TUE'][1].$params['TUE'][2].$params['TUE'][2].$params['TUE'][3].$params['TUE'][3];
                }
                if (strlen($params['WED']) == 4) {
                    $params['WED'] = $params['WED'][0].$params['WED'][1].$params['WED'][1].$params['WED'][2].$params['WED'][2].$params['WED'][3].$params['WED'][3];
                }
                if (strlen($params['THU']) == 4) {
                    $params['THU'] = $params['THU'][0].$params['THU'][1].$params['THU'][1].$params['THU'][2].$params['THU'][2].$params['THU'][3].$params['THU'][3];
                }
                if (strlen($params['FRI']) == 4) {
                    $params['FRI'] = $params['FRI'][0].$params['FRI'][1].$params['FRI'][1].$params['FRI'][2].$params['FRI'][2].$params['FRI'][3].$params['FRI'][3];
                }
                if (strlen($params['SAT']) == 4) {
                    $params['SAT'] = $params['SAT'][0].$params['SAT'][1].$params['SAT'][1].$params['SAT'][2].$params['SAT'][2].$params['SAT'][3].$params['SAT'][3];
                }
                if (strlen($params['SUN']) == 4) {
                    $params['SUN'] = $params['SUN'][0].$params['SUN'][1].$params['SUN'][1].$params['SUN'][2].$params['SUN'][2].$params['SUN'][3].$params['SUN'][3];
                }
    ...
    private function ajax_cal_day($TPL, $params) {
        ...
        if (!isset($params['dayNum'])) {
            $params['dayNum'] = date('z');
        }
    ...
    private function buildFullCalendarDay($params) {
        ...
        if (!$startHour) {
            $startHour = $this->getDefaultStartHour();
        }
        ...
        while ($startHour <= $endHour) {
            ...
            // Prepend zero if 1-9
            if ($startHour < 10 && strlen($startHour) == 1) {
                $startHour = "0".$startHour;
            }
