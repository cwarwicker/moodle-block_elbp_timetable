...
namespace block_elbp\Plugins\Timetable;
...
class Lesson {
    ...
    public function getTextInfo() {
        ...
        if (!empty($this->staff)) {
            $output .= elbp_html($this->staff) . "\n";
        }
        if (!empty($this->room)) {
            $output .= get_string('room', 'block_elbp_timetable') . ": " . elbp_html($this->room);
        }
        return $output;
    }
    ...
    public function getPopupInfo() {
        ...
        $output .= "<br>";
        if (!empty($this->staff)) {
            $output .= get_string('teachingstaff', 'block_elbp_timetable') . ": " . elbp_html($this->staff) . "<br>";
        }
        if (!empty($this->room)) {
            $output .= get_string('room', 'block_elbp_timetable') . ": " . elbp_html($this->room) . "<br>";
        }
        $output .= "<br>";
